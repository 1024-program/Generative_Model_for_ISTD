...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, device, fid_record, sample_z, best_fid):
    ...
    for idx in pbar:
        ...
        if i % args.eva_iter == 0:
            ...
            print('-------------Eva FID------------')
            fid = fid_score.calculate_fid_given_paths([eva_dir, '../dataset/%s/128/train/backgrounds' % args.dataset],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default='grass', help="path to the lmdb dataset")
    ...
    args.path = '../dataset/%s/128/train/backgrounds' % args.dataset
    if args.regan:
