...
class WandbLogger:
    ...
    def __init__(self, opt):
        ...
        if self.config.get('log_eval', None):
            self.eval_table = self._wandb.Table(columns=['image',
                                                         'pred_mask',
                                                         'label_mask',
                                                         'mIoU',
                                                         'PD',
        ...
        if self.config.get('log_infer', None):
            self.infer_table = self._wandb.Table(columns=['image',
                                                         'pred_mask',
                                                         'label_mask'])
        else:
    ...
    def log_eval_data(self, fake_img, sr_img, hr_img, psnr=None, ssim=None, fa=None):
        """
