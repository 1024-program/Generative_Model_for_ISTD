...
class Encoder(nn.Module):
    ...
    def forward(self, emb1, emb2, emb3, emb4,  emb1_masks, emb2_masks, emb3_masks, emb4_masks):
        ...
        for i in range(0, len(self.layer), 2):
            ...
            # emb1_masks, emb2_masks, emb3_masks, emb4_masks, weights = layer_block(emb1, emb2, emb3, emb4,  emb1_masks, emb2_masks, emb3_masks, emb4_masks)
            emb1, emb2, emb3, emb4, weights = layer_block(emb1, emb2, emb3, emb4,  emb1_masks, emb2_masks, emb3_masks, emb4_masks)
            layer_block = self.layer[i+1]
            # emb1, emb2, emb3, emb4, weights = layer_block(emb1_masks, emb2_masks, emb3_masks, emb4_masks, emb1,
            #                                                                       emb2, emb3, emb4)
            emb1_masks, emb2_masks, emb3_masks, emb4_masks = emb1, emb2, emb3, emb4
            emb1, emb2, emb3, emb4, weights = layer_block(emb1, emb2, emb3, emb4,  emb1_masks, emb2_masks, emb3_masks, emb4_masks)
            emb1_masks, emb2_masks, emb3_masks, emb4_masks = emb1, emb2, emb3, emb4
            if self.vis:
